...
const Signup = () => {
  return (
    ...
    <div className="text-black  bg-slate-500 backdrop-blur-xl bg-white/30 ... xl:mx-96 xl:my-20 md:mx-56 md:my-0   lg:mx-80 lg:my-20  text-center rounded-xl ">
      <h1 className="font-serif font-semiboldd text-2xl pt-10 xl:text-4xl ">Sign Up</h1>
      ...
      <p className="xl:text-xl text-xs py-4">Already a member with us?  <a href="/" className="xl:text-xl  group hover:text-gray-200"> Login</a></p>
    </div>
    {/* <Footer/> */}
  </div>
  )
